...
import {
  SP_NGX_HELPER_CONFIG,
  SPNgxHelperConfig,
} from '@smallpearl/ngx-helper/core';
import {
  FIELD_VALUE_FN,
...
describe('SPMatEntityListComponent', () => {
  ...
  beforeEach(async () => {
    ...
    componentRef.setInput('endpoint', 'https://randomuser.me/api/?results=100');
  });
  ...
  it('should use global config object', async () => {
    ...
    spyOn(helperConfig, 'i18nTranslate').and.callFake(
      (label: string, context?: any) => {
